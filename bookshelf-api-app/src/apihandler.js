...
const books = require('./apibooks');

const getAllBooksAPIHandler = (request, h) => {
  const { name, reading, finished } = request.query;

  if (name) {
    const filterByName = books.filter(
...
const getBookByIdAPIHandler = (request, h) => {
...
const addBookAPIHandler = (request, h) => {
  const {
    name,
    year,
    author,
...
const deleteBookByIdAPIHandler = (request, h) => {
  const { id } = request.params;
...
const editBookByIdAPIHandler = (request, h) => {
  const { id } = request.params;
